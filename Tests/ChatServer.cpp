...
MsgComm nhu;
int main () {
	int port = (int) toLL (ini.get("port", "16472"));
	string host = ini.get ("host", "127.0.0.1"); // yes, local host by default
	serverInitialize (&nhu, port, &connectors, &requestTable);
	serverFinalize ();
}
